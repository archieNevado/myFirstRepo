...
import com.coremedia.rest.cap.validators.TaxonomyLocalesConfigurationProperties;
...
@EnableConfigurationProperties({
        ...
        TaxonomyLocalesConfigurationProperties.class,
...
public class ValidatorsAutoConfiguration {
  ...
  @Bean
  @ConditionalOnProperty(name = "validator.enabled.taxonomy-locales-validator.taxonomy-locales", matchIfMissing = true)
  AvailableLocalesValidator taxonomyLocalesValidator(TaxonomyLocalesConfigurationProperties taxonomyLocalesConfigurationProperties) {
    return new AvailableLocalesValidator(
            taxonomyLocalesConfigurationProperties.getContentPath(),
            taxonomyLocalesConfigurationProperties.getPropertyPath()
    );
  }
  ...
  ContentTypeValidator cmDownloadValidator(CapConnection connection) {
