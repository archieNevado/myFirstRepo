...
# create environment folders if missing
mkdir -p {$CATALINA_TMPDIR,@LOG_ROOT@,@PID_ROOT@,@TMP_ROOT@}
chown -R @INSTALL_USER@. {$CATALINA_TMPDIR,@LOG_ROOT@,@PID_ROOT@,@TMP_ROOT@}
