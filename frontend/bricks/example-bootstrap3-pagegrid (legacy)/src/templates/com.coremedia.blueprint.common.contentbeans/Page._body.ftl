...
<body id="top" <@preview.metadata data=bp.setting(cmpage, "sliderMetaData", "") />>
  ...
  <#if bp.setting(cmpage.navigation, "render_skip_links", true)>
    <div class="cm-skiplinks">
      <a class="sr-only sr-only-focusable" href="#cm-navigation"><@cm.message "skiplinks_navigation" /></a>
      <a class="sr-only sr-only-focusable" href="#cm-placement-main"><@cm.message "skiplinks_content" /></a>
      <a class="sr-only sr-only-focusable" href="#cm-search-query"><@cm.message "skiplinks_search" /></a>
    </div>
  </#if>
  ...
  <#if bp.setting(cmpage.navigation, "render_back_to_top_button", true)>
    <a id="back-to-top" href="#" class="btn btn-primary cm-back-to-top" role="button" title="<@cm.message key="button_top" highlightErrors=false />" data-toggle="tooltip" data-placement="left">
