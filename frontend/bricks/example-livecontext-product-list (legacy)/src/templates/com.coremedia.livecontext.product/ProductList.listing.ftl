...
<#-- in blueprint rootNavigation declared as Navigation is instance of CMChannel -->
  ...
  <#if self.isProductCategory() && self.loadedProducts?has_content>
    <@cm.include self=bp.getContainer(self.loadedProducts) view="asGrid" params={"itemsPerRow": 4, "itemsPerMobileRow":2, "additionalClass": "cm-product-list-grid", "viewItems": "asCategoryItem", "center": false} />
  </#if>
</#if>
