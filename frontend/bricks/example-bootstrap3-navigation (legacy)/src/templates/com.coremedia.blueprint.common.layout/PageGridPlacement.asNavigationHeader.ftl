...
<div class="container"<@preview.metadata data=[bp.getPlacementPropertyName(self), bp.getPlacementHighlightingMetaData(self)!""]/>>
  <header id="cm-${self.name!""}" class="cm-header cm-header--navigation navbar">
