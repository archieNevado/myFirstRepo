...
const NAVIGATION_ROOT_ELEMENT = NAVIGATION_SELECTOR + NAVIGATION_ROOT_BLOCK + "__list";
const NAVIGATION_ROOT_MODIFIER = NAVIGATION_PREFIX + "--hovered";

const NAVIGATION_ENTRY_SELECTOR_CLASS = NAVIGATION_SELECTOR + NAVIGATION_PREFIX + "-item-depth-1";
  ...
  nodeDecorationService.addNodeDecoratorBySelector(
    ...
    function($target) {
      ...
      $navigationEntryBlock.mouseover(function() {
        ...
        $(this).find("ul.cm-navigation-item__list").css("opacity", 1);
