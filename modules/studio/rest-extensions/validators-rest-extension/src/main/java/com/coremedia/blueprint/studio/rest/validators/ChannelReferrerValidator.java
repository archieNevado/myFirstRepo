...
public class ChannelReferrerValidator extends ContentTypeValidatorBase {
  ...
  private String duplicateReferrerCode = "duplicate_referrer";

  public void setDuplicateReferrerCode(String duplicateReferrerCode) {
    this.duplicateReferrerCode = duplicateReferrerCode;
  }
  ...
  public void validate(Content content, Issues issues) {
    ...
    if (referrers.size() > 1) {
      ...
      issues.addIssue(Severity.WARN, null, duplicateReferrerCode);
    }
  }
}
