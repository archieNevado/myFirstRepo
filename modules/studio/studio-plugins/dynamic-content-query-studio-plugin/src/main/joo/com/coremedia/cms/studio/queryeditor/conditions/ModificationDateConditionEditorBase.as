...
public class ModificationDateConditionEditorBase extends ConditionEditorBase {
  ...
  public function ModificationDateConditionEditorBase(config:modificationDateConditionEditor = null) {
  ...
  override protected function afterRender():void {
    ...
    applyModificationDateBaseStruct(bindTo, contentType, propertyName);
  }
  ...
  protected function applyModificationDateBaseStruct(bindTo:ValueExpression, contentType:String, structPropertyName:String):void {
    ...
    fq.getType().addStringProperty(EXPRESSION_PREFIX, timeSlots[0].name);
  }
