...
public class RemoveTaxonomyAction extends Action {
  ...
  public function RemoveTaxonomyAction(config:removeTaxonomyAction = null) {
    config.handler = removeTaxonomy;
    config.text = TaxonomyStudioPlugin_properties.INSTANCE.TaxonomyLinkList_keyword_remove_text;
    super(config);
