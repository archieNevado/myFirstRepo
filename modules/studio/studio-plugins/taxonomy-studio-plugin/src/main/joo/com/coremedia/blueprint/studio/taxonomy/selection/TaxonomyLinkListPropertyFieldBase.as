...
import com.coremedia.cms.editor.sdk.config.linkListPropertyField;
...
public class TaxonomyLinkListPropertyFieldBase extends LinkListPropertyField {
  ...
  public function TaxonomyLinkListPropertyFieldBase(config:taxonomyLinkListPropertyField = null) {
    super(config);
  ...
  private function getChooserButton():Button {
    return linkListPropertyField.FIND_TOOLBAR(this).find('itemId', OPEN_TAXONOMY_CHOOSER_BUTTON_ITEM_ID)[0];
  }
