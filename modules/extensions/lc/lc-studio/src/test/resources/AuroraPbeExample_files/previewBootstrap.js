...
coremedia.preview = (function (module) {
  ...
  module.initHandler = function (event) {
    $('body').attr('data-cm-metadata', '[{"cm_preferredWidth":1281,"cm_responsiveDevices":{"mobile_portrait":{"width":320,"height":480,"order":1,"isDefault":true},"mobile_landscape":{"width":480,"height":320,"order":2},"tablet_portrait":{"width":600,"height":800,"order":3},"hybrid_app_portrait":{"width":768,"height":1024,"order":4},"tablet_landscape":{"width":960,"height":540,"order":5},"hybrid_app_landscape":{"width":1024,"height":768,"order":6},"desktop":{"width":1281,"height":1024,"order":7}}}]')
    ...
    if (msgJson && msgJson.type === "initConfirm") {
      ...
      if (module.studioUrlWhitelist.length > 0) {
        $.each(module.studioUrlWhitelist, function (index, element) {
          parser.href = element;
...
coremedia.preview.$ && coremedia.preview.$(function () {
  // init preview
