...
import com.coremedia.cms.editor.sdk.config.previewContextMenu;
import com.coremedia.cms.editor.sdk.context.ComponentContextHelper;
...
import com.coremedia.livecontext.studio.config.metadataToEntitiesActionAdapter;
 ...
 */
public class MetadataToEntitiesActionAdapter extends MetadataBeanAction {
  ...
  public function MetadataToEntitiesActionAdapter(config:metadataToEntitiesActionAdapter = null) {
    ...
    var newConfig:metadataToEntitiesActionAdapter = metadataToEntitiesActionAdapter(Ext.apply({
      iconCls: backingAction.getIconClass(),
  ...
  internal function registerResetResolvedBeanHandler():void {
    if (!myContextMenu) {
      myContextMenu = ComponentContextHelper.getOwnerCt(this).findParentByType(previewContextMenu.xtype) as PreviewContextMenu;
