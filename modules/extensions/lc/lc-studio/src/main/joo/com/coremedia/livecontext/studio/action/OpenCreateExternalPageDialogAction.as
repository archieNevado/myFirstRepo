...
import com.coremedia.blueprint.base.components.config.openQuickCreateAction;
...
public class OpenCreateExternalPageDialogAction extends OpenQuickCreateAction {
  ...
  protected override function getDialogConfig(trigger:Component):ext.config.window {
    //create the dialog
    var dialogConfig:quickCreateDialog = new quickCreateDialog(Ext.apply({}, initialConfig));
