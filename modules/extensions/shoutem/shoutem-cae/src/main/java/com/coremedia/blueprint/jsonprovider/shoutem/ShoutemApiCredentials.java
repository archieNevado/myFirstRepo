...
public class ShoutemApiCredentials {
  ...
  /**
   * Returns the segment (according to UrlPathFormattingHelper#getVanity)
   * of the site's root channel.
   */
  ...
  /**
   * Must be the segment (according to UrlPathFormattingHelper#getVanity)
   * of the site's root channel.
   */
