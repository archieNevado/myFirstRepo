...
public class CommerceSegmentCondition extends AbstractCondition{
  ...
  public function CommerceSegmentCondition(config:commerceSegmentCondition = null) {
  ...
  private function initSegmentSelector():void {
    var segmentSelectorCfg:commerceObjectSelector = new commerceObjectSelector();
    segmentSelectorCfg.itemId = "segmentSelector";
    segmentSelectorCfg.flex = 30;
    segmentSelectorCfg.emptyText = LivecontextStudioPlugin_properties.INSTANCE.p13n_commerce_user_segments_selector_emptyText;
    segmentSelectorCfg.getCommerceObjectsFunction = LivecontextP13NStudioPluginBase.getSegments;
    segmentSelectorCfg.minListWidth = 200;
    segmentSelectorCfg.margins = "0 5 0 5";
