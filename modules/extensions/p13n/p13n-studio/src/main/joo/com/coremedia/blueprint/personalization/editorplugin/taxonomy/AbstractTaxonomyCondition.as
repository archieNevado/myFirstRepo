...
public class AbstractTaxonomyCondition extends AbstractCondition {
   ...
   */
  public function AbstractTaxonomyCondition(config:abstractTaxonomyCondition = null) {
  ...
  public function addTaxonomyButton():void {
    ...
    var btnCfg:button = new button();
    btnCfg.iconCls = 'add-taxonomies-icon';
    btnCfg.margins = '0 3 0 3';
    btnCfg.buttonSelector = "a";
    btnCfg.tooltip = TaxonomyStudioPlugin_properties.INSTANCE.Taxonomy_action_tooltip;
    btnCfg.baseAction = openChooserAction;
    btnCfg.template = new Template([
      '<div id="{4}" class="{2} icon-button-xs">',
      '<em class="wrapper-btn-xs"><a href="#">&nbsp;</a></em>',
      '</div>']).compile();
    var btn:Button = new Button(btnCfg);
