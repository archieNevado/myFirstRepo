  ...
  <ul class="am-breadcrumb">
      <li class="am-breadcrumb__item am-breadcrumb-item am-breadcrumb-item--link">
        ...
        <li class="am-breadcrumb__item am-breadcrumb-item am-breadcrumb-item--child">
          <span class="am-breadcrumb-item__text"<@cm.metadata data=[self.taxonomy.content, "properties.value"] />>${bp.getMessage(am.messageKeys.TAG)}: ${self.taxonomy.value!""}</span>
        </li>
    </ul>
</div>
...
<h1 class="am-download-portal__title am-heading-1">
  ${bp.getMessage(am.messageKeys.DOWNLOAD_PORTAL)}
</h1>
