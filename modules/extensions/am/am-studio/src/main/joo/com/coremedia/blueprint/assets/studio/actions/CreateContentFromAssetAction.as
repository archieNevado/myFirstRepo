...
import com.coremedia.blueprint.assets.studio.config.createContentFromAssetAction;
...
public class CreateContentFromAssetAction extends ContentAction {
  ...
  public function CreateContentFromAssetAction(config:createContentFromAssetAction = null) {
    ...
    super(createContentFromAssetAction(ActionConfigUtil.extendConfiguration(
            AMStudioPlugin_properties.INSTANCE,
            config,
  ...
  private function createSingleContent(contents:Array, i:int):void {
    ...
    var quickCreateConfig:quickCreateDialog = new quickCreateDialog();
    ...
    var dialog:QuickCreateDialog = QuickCreateDialog(ComponentMgr.create(quickCreateConfig));
    dialog.show();
  }
}
}
