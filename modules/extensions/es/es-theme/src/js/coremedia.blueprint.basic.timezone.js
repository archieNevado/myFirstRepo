...
coremedia.blueprint.basic.timezone = (function (module) {
  ...
  return module;
}(coremedia.blueprint.basic.timezone || {}));
...
coremedia.blueprint.$(function () {
  ...
  $("#coremedia-blueprint-basic-timezone").val(coremedia.blueprint.basic.timezone.determine_timezone().name());
});