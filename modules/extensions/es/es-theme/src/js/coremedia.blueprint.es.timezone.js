...
coremedia.blueprint.es.timezone = (function (module) {
  /*
  ...
  var get_january_offset = function () {
    return get_date_offset(new Date(2010, 0, 1, 0, 0, 0, 0));
  };

  var get_june_offset = function () {
   ...
   * @returns {Boolean}
   */
  module.date_is_dst = function (date) {
  ...
  var lookup_key = function () {
    ...
    if (diff < 0) {
      ...
      return june_offset + ",1," + module.HEMISPHERE_SOUTH;
    }
   ...
   * @returns Object
   */
  module.determine_timezone = function () {
    var key = lookup_key();
    return new module.TimeZone(module.olson.timezones[key]);
  };
   ...
   */
  module.TimeZone = function (tz_info) {
  ...
  module.TimeZone.prototype.dst = function () {
    return this.uses_dst;
  };

  module.TimeZone.prototype.offset = function () {
   ...
   */
  module.TimeZone.prototype.is_ambiguous = function () {
    return typeof (module.olson.ambiguity_list[this.name()]) !== 'undefined';
  };
   ...
   * timezones.
   */
  module.TimeZone.prototype.ambiguity_check = function () {
    var ambiguity_list = module.olson.ambiguity_list[this.name()],
    ...
    for (; i < length; i += 1) {
      ...
      if (module.date_is_dst(module.olson.dst_start_dates[tz])) {
  ...
  return module;
}(coremedia.blueprint.es.timezone || {}));
...
coremedia.blueprint.$(function () {
  ...
  $("#coremedia-blueprint-basic-timezone").val(coremedia.blueprint.es.timezone.determine_timezone().name());
});