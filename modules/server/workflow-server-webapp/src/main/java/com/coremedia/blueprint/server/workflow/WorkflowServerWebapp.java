package com.coremedia.blueprint.server.workflow;
...
public class WorkflowServerWebapp extends SpringBootServletInitializer {

  /**
   * Use spring-boot-maven plugin to run to avoid https://youtrack.jetbrains.com/issue/IDEA-107048
   */
  public static void main(String[] args) {
    new SpringApplication(WorkflowServerWebapp.class).run(args);
  }
