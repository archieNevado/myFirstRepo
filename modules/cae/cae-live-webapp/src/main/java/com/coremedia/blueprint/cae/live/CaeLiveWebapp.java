package com.coremedia.blueprint.cae.live;
...
public class CaeLiveWebapp extends SpringBootServletInitializer {

  /**
   * Use spring-boot-maven plugin to run to avoid https://youtrack.jetbrains.com/issue/IDEA-107048
   */
  public static void main(String[] args) {
    new SpringApplication(CaeLiveWebapp.class).run(args);
  }
