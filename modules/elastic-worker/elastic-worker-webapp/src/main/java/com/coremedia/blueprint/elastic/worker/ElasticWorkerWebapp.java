package com.coremedia.blueprint.elastic.worker;
...
public class ElasticWorkerWebapp extends SpringBootServletInitializer {

  /**
   * Use spring-boot-maven plugin to run to avoid https://youtrack.jetbrains.com/issue/IDEA-107048
   */
  public static void main(String[] args) {
    new SpringApplication(ElasticWorkerWebapp.class).run(args);
  }
