 ...
 *
 */
coremedia.blueprint.livecontext.deviceSettings = function (module) {
  ...
  var devices = {
    ...
    "tablet": {
      ...
      removeSettings: function ($target) {
        ...
        coremedia.blueprint.livecontext.unsetMarketingSpotItemsHeight();
        removeDropdown($target);
    ...
    "desktop": {
      ...
      removeSettings: function ($target) {
        ...
        coremedia.blueprint.livecontext.unsetMegaMenuItemsWidth();
  ...
  return module;
}(coremedia.blueprint.livecontext.deviceSettings || {});
...
coremedia.blueprint.$(function () {
  ...
  $document.on(coremedia.blueprint.deviceDetector.EVENT_DEVICE_CHANGED, function (event, newDevice, oldDevice) {
    coremedia.blueprint.livecontext.deviceSettings.removeSettings(oldDevice.type, oldDevice.orientation, $document);
    if (oldDevice.type !== newDevice.type) {
      coremedia.blueprint.livecontext.deviceSettings.removeSettings(oldDevice.type, undefined, $document);
      coremedia.blueprint.livecontext.deviceSettings.applySettings(newDevice.type, undefined, $document);
    }
    coremedia.blueprint.livecontext.deviceSettings.applySettings(newDevice.type, newDevice.orientation, $document);
  ...
  $document.on(coremedia.blueprint.basic.EVENT_NODE_APPENDED, function (event, $node) {
    ...
    coremedia.blueprint.livecontext.deviceSettings.applySettings(device.type, device.orientation, $node);
  });
});
