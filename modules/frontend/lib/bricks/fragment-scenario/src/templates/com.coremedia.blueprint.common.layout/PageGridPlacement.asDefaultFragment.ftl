...
<div class="cm-placement cm-placement--fragment cm-placement-${self.name!""}" <@cm.metadata data=[bp.getPlacementPropertyName(self)!"",lc.fragmentHighlightingMetaData(self)!""] />>
