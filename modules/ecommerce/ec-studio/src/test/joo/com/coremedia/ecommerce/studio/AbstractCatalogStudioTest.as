...
public class AbstractCatalogStudioTest extends AbstractCatalogTest {
  ...
  protected static const ROOT_CATEGORY_ID:String = "livecontext/category/" + STORE_CONTEXT_ID + "/ROOT";
  protected static const MARKETING_ID:String = "livecontext/marketing/" + STORE_CONTEXT_ID;
  protected static const TOP_CATEGORY_ID:String = "livecontext/category/" + STORE_CONTEXT_ID + "/Grocery";
  protected static const LEAF_CATEGORY_ID:String = "livecontext/category/" + STORE_CONTEXT_ID + "/Fruit";
