package com.coremedia.blueprint.caefeeder.preview;
...
public class CaefeederPreviewWebapp extends SpringBootServletInitializer {

  /**
   * Use spring-boot-maven plugin to run to avoid https://youtrack.jetbrains.com/issue/IDEA-107048
   */
  public static void main(String[] args) {
    new SpringApplication(CaefeederPreviewWebapp.class).run(args);
  }
