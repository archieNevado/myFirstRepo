...
default['blueprint']['spring-boot']['headless-server-preview']['heap'] = '512m'
default['blueprint']['spring-boot']['headless-server-preview']['boot_opts'] = {}
default['blueprint']['spring-boot']['headless-server-live']['heap'] = '512m'
...
default['blueprint']['spring-boot']['commerce-adapter-wcs']['heap'] = '64m'
