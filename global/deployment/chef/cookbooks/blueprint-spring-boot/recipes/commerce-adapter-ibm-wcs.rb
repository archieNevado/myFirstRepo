...
service_name = 'commerce-adapter-wcs'
...
node.default_unless['blueprint']['apps'][service_name]['application.properties']['grpc.server.port'] = '44365'
node.default_unless['blueprint']['apps'][service_name]['application.properties']['server.port'] = '44380'
node.default_unless['blueprint']['apps'][service_name]['application.properties']['management.server.port'] = '44381'
node.default_unless['blueprint']['apps']['studio-server']['application.properties']['commerce.hub.data.endpoints.wcs'] = 'localhost:44365'
node.default_unless['blueprint']['apps']['cae-preview']['application.properties']['commerce.hub.data.endpoints.wcs'] = 'localhost:44365'
node.default_unless['blueprint']['apps']['cae-live']['application.properties']['commerce.hub.data.endpoints.wcs'] = 'localhost:44365'
node.default_unless['blueprint']['apps']['headless-server-preview']['application.properties']['commerce.hub.data.endpoints.wcs'] = 'localhost:44365'
node.default_unless['blueprint']['apps']['headless-server-live']['application.properties']['commerce.hub.data.endpoints.wcs'] = 'localhost:44365'
node.default_unless['blueprint']['apps']['content-feeder']['application.properties']['commerce.hub.data.endpoints.wcs'] = 'localhost:44365'
...
if spring_boot_default(service_name, 'debug')
  java_opts_hash['debug'] = '-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:44305'
end
...
spring_boot_application service_name do
  ...
  post_start_wait_url "http://localhost:44381/actuator/health"
  ...
  jmx_remote_registry_port 44399
  jmx_remote_server_port 44398
