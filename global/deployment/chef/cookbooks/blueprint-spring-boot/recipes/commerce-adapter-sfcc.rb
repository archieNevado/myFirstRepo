...
service_name = 'commerce-adapter-sfcc'
...
if spring_boot_default(service_name, 'debug')
  java_opts_hash['debug'] = '-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:44105'
end
...
spring_boot_application service_name do
  ...
  post_start_wait_url "http://localhost:44181/actuator/health"
  ...
  jmx_remote_registry_port 44199
  jmx_remote_server_port 44198
