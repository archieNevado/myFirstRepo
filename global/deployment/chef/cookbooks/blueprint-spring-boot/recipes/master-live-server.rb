...
node.default_unless['blueprint']['apps'][service_name]['application.properties']['spring.application.name'] = 'master-live-server'
node.default_unless['blueprint']['apps'][service_name]['application.properties']['cap.server.http-port'] = '40280'
node.default_unless['blueprint']['apps'][service_name]['application.properties']['server.port'] = '40280'
node.default_unless['blueprint']['apps'][service_name]['application.properties']['management.server.port'] = '40281'
...
node.default_unless['blueprint']['apps'][service_name]['application.properties']['com.coremedia.corba.server.port'] = "40283"
...
if spring_boot_default(service_name, 'debug')
  java_opts_hash['debug'] = '-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:40206'
end
...
spring_boot_application service_name do
  ...
  post_start_wait_url "http://localhost:40280/ior"
  ...
  jmx_remote_registry_port 40299
  jmx_remote_server_port 40298
