...
* `node['blueprint']['apps']['commerce-adapter-mock']['version']` -  Defaults to `1.0.9`.
...
* `node['blueprint']['apps']['commerce-adapter-hybris']['version']` -  Defaults to `1.0.5`.
...
* `node['blueprint']['apps']['commerce-adapter-sfcc']['version']` -  Defaults to `1.0.4`.
...
* `node['blueprint']['apps']['commerce-adapter-wcs']['version']` -  Defaults to `1.0.6`.
