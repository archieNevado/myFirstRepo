...
* `node['blueprint']['apps']['commerce-adapter-hybris']['version']` -  Defaults to `1.1.13`.
...
* `node['blueprint']['apps']['commerce-adapter-sfcc']['version']` -  Defaults to `1.1.16`.
...
* `node['blueprint']['apps']['commerce-adapter-wcs']['version']` -  Defaults to `1.3.5`.
