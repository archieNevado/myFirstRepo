...
* `node['blueprint']['apps']['commerce-adapter-mock']['version']` -  Defaults to `1.7.3`.
...
* `node['blueprint']['apps']['commerce-adapter-hybris']['version']` -  Defaults to `1.5.3`.
...
* `node['blueprint']['apps']['commerce-adapter-sfcc']['version']` -  Defaults to `1.5.3`.
...
* `node['blueprint']['apps']['commerce-adapter-wcs']['version']` -  Defaults to `1.7.3`.
