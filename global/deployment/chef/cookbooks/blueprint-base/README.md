...
* `node['blueprint']['apps']['commerce-adapter-mock']['version']` -  Defaults to `1.6.7`.
...
* `node['blueprint']['apps']['commerce-adapter-hybris']['version']` -  Defaults to `1.4.2`.
...
* `node['blueprint']['apps']['commerce-adapter-sfcc']['version']` -  Defaults to `1.4.4`.
...
* `node['blueprint']['apps']['commerce-adapter-wcs']['version']` -  Defaults to `1.6.2`.
