...
* `node['blueprint']['apps']['commerce-adapter-hybris']['version']` -  Defaults to `1.0.10`.
...
* `node['blueprint']['apps']['commerce-adapter-sfcc']['version']` -  Defaults to `1.0.6`.
...
* `node['blueprint']['apps']['commerce-adapter-wcs']['version']` -  Defaults to `1.0.12`.
