...
default['blueprint']['proxy']['virtual_host']['preview']['sites']['helios']['default_site'] = 'perfectchef'
...
default['blueprint']['proxy']['virtual_host']['delivery']['sites']['helios']['default_site'] = 'perfectchef'
default['blueprint']['proxy']['virtual_host']['delivery']['sites']['helios']['sitemap_site_name'] = 'PerfectChef'
