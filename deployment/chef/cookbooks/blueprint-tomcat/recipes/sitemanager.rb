...
node.default_unless['blueprint']['webapps'][service_name]['editor.properties']['user.manual.url'] = 'https://documentation.coremedia.com/editor-user/1804.1/editor-user-{0}.pdf'
