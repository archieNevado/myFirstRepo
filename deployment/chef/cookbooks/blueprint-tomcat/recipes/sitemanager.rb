...
node.default['blueprint']['webapps'][service_name]['editor.properties']['user.manual.url'] = 'https://documentation.coremedia.com/editor-user/1704.1-10/editor-user-{0}.pdf'
...
node.default['blueprint']['webapps'][service_name]['jnlp_token']['SITE_MANAGER_SSL_PASSPHRASE'] = ''
...
node.default['blueprint']['proxy']['virtual_host']['sitemanager']['http_port'] = "#{node['blueprint']['tomcat'][service_name]['port_prefix']}80"
