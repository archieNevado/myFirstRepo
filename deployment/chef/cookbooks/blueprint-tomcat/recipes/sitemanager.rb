...
node.default['blueprint']['webapps'][service_name]['editor.properties']['user.manual.url'] = 'https://documentation.coremedia.com/editor-user/1701.2-16/editor-user-{0}.pdf'
