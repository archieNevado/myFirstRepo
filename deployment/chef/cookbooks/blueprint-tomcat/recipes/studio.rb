...
node.default['blueprint']['webapps'][service_name]['application.properties']['studio.previewUrlPrefix'] = "//preview.#{node['blueprint']['hostname']}"
node.default['blueprint']['webapps'][service_name]['application.properties']['studio.previewUrlWhitelist'] = "*.#{node['blueprint']['hostname']}"
...
node.default['blueprint']['webapps'][service_name]['application.properties']['externalpreview.restUrl'] = "http://preview.#{node['blueprint']['hostname']}/blueprint/servlet/service/externalpreview"
node.default['blueprint']['webapps'][service_name]['application.properties']['externalpreview.previewUrl'] = "https://preview.#{node['blueprint']['hostname']}/blueprint/externalpreview"
node.default['blueprint']['webapps'][service_name]['application.properties']['externalpreview.urlPrefix'] = "https://preview.#{node['blueprint']['hostname']}"
