...
* `node['blueprint']['tools']['css-importer']['group_id']` -  Defaults to `com.coremedia.blueprint`.
* `node['blueprint']['tools']['css-importer']['artifact_id']` -  Defaults to `css-importer-application`.
* `node['blueprint']['tools']['css-importer']['version']` -  Defaults to `node['blueprint']['default_version']`.
...
* `node['blueprint']['common_libs']['slf4j-api.jar']['version']` -  Defaults to `1.7.6`.
* `node['blueprint']['common_libs']['slf4j-api.jar']['checksum']` -  Defaults to `059a84383fad78d85d9c3951bebafab7200c704c411a9d25c913340c3877604a`.
...
* `node['blueprint']['common_libs']['jul-to-slf4j.jar']['version']` -  Defaults to `1.7.6`.
* `node['blueprint']['common_libs']['jul-to-slf4j.jar']['checksum']` -  Defaults to `b71451847d2643a1bfe83df69fbf696860fe2689b95c9bd96188fb7808444f64`.
...
* `node['blueprint']['common_libs']['jcl-over-slf4j.jar']['version']` -  Defaults to `1.7.6`.
* `node['blueprint']['common_libs']['jcl-over-slf4j.jar']['checksum']` -  Defaults to `d52f5e9a861f4e124ec43d711b566b4c2afe6e0709b490497fb9ca33e1ca0ba5`.
...
* `node['blueprint']['common_libs']['slf4j-log4j12.jar']['version']` -  Defaults to `1.7.6`.
* `node['blueprint']['common_libs']['slf4j-log4j12.jar']['checksum']` -  Defaults to `df49e9357c7adc5242abbf399c0cf2d54e470b9126fc641d67e13f48716d2932`.
...
* `node['blueprint']['wcs']['application.properties']['livecontext.cookie.domain']` -  Defaults to `node['domain']`.
