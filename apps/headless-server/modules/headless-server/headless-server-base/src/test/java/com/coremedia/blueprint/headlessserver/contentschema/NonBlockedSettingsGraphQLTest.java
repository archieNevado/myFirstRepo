...
import static com.coremedia.blueprint.headlessserver.contentschema.TestRepoConstants.SETTINGS_REPO_PATH;
...
@SpringBootTest(classes = {
        ...
        NonBlockedSettingsGraphQLTest.LocalTestConfiguration.class,
}, properties = {
...
class NonBlockedSettingsGraphQLTest {
  ...
  void testGetBlockedSettingsById() {
    webGraphQlTester.documentName("settingsById")
            ...
            .execute()
            .path("content.content.id").entity(Integer.class).isEqualTo(CLANDESTINE_SETTINGS_ID)
            .path("content.content.name").entity(String.class).isEqualTo("ClandestineSettings")
            .path("content.content.repositoryPath").entity(String.class).isEqualTo(SETTINGS_REPO_PATH)
            .path("content.content.settings.clandestine").hasValue();
  }
  ...
  void testGetBlockedSettingsViaLinkedSettings() {
    webGraphQlTester.documentName("linkedSettingsById")
            ...
            .path("content.page.settings.clandestine").hasValue();
  }
  ...
  void testGetBlockedSettingsViaSite() {
    webGraphQlTester.documentName("linkedSettingsBySite")
            ...
            .path("content.site.root.settings.clandestine").hasValue();
  }
