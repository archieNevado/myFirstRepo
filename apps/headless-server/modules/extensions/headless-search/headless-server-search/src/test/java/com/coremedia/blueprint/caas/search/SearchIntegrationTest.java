...
public class SearchIntegrationTest {
  ...
  public void setup() {
    ...
    when(graphQLContext.get(ValidityDateFilterPredicate.VIEW_DATE)).thenReturn(ZonedDateTime.now());
  ...
  void searchConfigTest() {
    ...
    DataFetcherResult<SearchResult> searchResult = getSearchServiceAdapter().search("test", null, null, null, null, null, null, Collections.emptyList());
  ...
  void customSolrFieldsTest_error() {
    DataFetcherResult<SearchResult> result = getSearchServiceAdapter().search("test", null, null, Collections.emptyList(), Collections.singletonList("INVALIDFIELD_DESC"), null, null, Collections.emptyList());
