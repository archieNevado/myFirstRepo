            ...
            Config(AddItemsPlugin, {
              items: [
                Config(OpenAnalyticsHomeUrlButton, {
                  itemId: "btn-analytics-webtrends",
                  tooltip: WebtrendsStudioPlugin_properties.webtrends_fav_btn_tooltip,
                  text: WebtrendsStudioPlugin_properties.webtrends_fav_btn_text,
