...
class SearchProductPicturesActionBase extends LiveContextCatalogObjectAction {
  ...
  constructor(config: Config<SearchProductPicturesAction> = null) {
    ...
    const this$ = this;
    super(cast(SearchProductPicturesAction, ActionConfigUtil.extendConfiguration(resourceManager.getResourceBundle(null, ECommerceStudioPlugin_properties).content, config, "searchProductPictures", { handler: bind(this$, this$.#myHandler) })));
  }
