...
class AddAssetLinkPlugin extends NestedRulesPlugin {
  ...
  #componentConfig: DocumentTabPanel = null;

  constructor(config: Config<AddAssetLinkPlugin> = null) {
    // @ts-expect-error Ext JS semantics
    const this$ = this;
    this$.#componentConfig = cast(DocumentTabPanel, config.cmp.initialConfig);
            ...
            Config(AddItemsPlugin, {
              items: [
                Config(PropertyFieldGroup, {
                  ...
                  title: config.title,
                  forceReadOnlyValueExpression: this$.#componentConfig.forceReadOnlyValueExpression,
                  items: [
