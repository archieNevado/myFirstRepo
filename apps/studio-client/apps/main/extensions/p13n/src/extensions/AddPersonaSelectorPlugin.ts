...
class AddPersonaSelectorPlugin extends NestedRulesPlugin {
  ...
  #myPreviewPanel: PreviewPanel = null;

  #previewPanelConfig: PreviewPanel = null;

  constructor(config: Config<AddPersonaSelectorPlugin> = null) {
    // @ts-expect-error Ext JS semantics
    const this$ = this;
    this$.#myPreviewPanel = as(config.cmp, PreviewPanel);
    this$.#previewPanelConfig = cast(PreviewPanel, this$.#myPreviewPanel.initialConfig);
            ...
            Config(AddItemsPlugin, {
              items: [
                Config(PersonaSelector, {
                  ...
                  contentValueExpression: this$.#myPreviewPanel.getCurrentPreviewContentValueExpression(),
                  ...ConfigUtils.append({
                    plugins: [
                      Config(Addsitespecificpath, {
                        path: "Options/Personalization/Profiles",
                        activeContentValueExpression: this$.#previewPanelConfig.bindTo,
