...
class AddCatalogActionsToTreeViewContextMenuPlugin extends AddItemsPlugin {
  ...
  #componentConfig: TreeViewContextMenu = null;

  constructor(config: Config<AddCatalogActionsToTreeViewContextMenuPlugin> = null) {
    // @ts-expect-error Ext JS semantics
    const this$ = this;
    this$.#componentConfig = cast(TreeViewContextMenu, config.cmp.initialConfig);
    super(ConfigUtils.apply(Config(AddCatalogActionsToTreeViewContextMenuPlugin, {
      items: [
        Config(Item, {
          ...
          baseAction: new SearchProductVariantsAction({ catalogObjectExpression: this$.#componentConfig.selectedFolderValueExpression }),
        }),
        Config(Separator),
        Config(Item, {
          itemId: LivecontextStudioPlugin.AUGMENT_CATEGORY_MENU_ITEM_ID,
          baseAction: new AugmentCategoryAction({ catalogObjectExpression: this$.#componentConfig.selectedFolderValueExpression }),
        }),
        Config(Item, {
          itemId: LivecontextStudioPlugin.CREATE_PRODUCT_TEASER_MENU_ITEM_ID,
          baseAction: new CreateProductTeaserAction({ catalogObjectExpression: this$.#componentConfig.selectedFolderValueExpression }),
        }),
        Config(Item, {
          itemId: LivecontextStudioPlugin.CREATE_MARKETING_SPOT_MENU_ITEM_ID,
          baseAction: new CreateMarketingSpotAction({ catalogObjectExpression: this$.#componentConfig.selectedFolderValueExpression }),
        }),
      ],
      after: [
