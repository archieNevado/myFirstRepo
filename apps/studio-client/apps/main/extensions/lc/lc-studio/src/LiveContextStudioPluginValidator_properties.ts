 ...
 */
  ...
  Validator_CMProductList_invalid_legacy_name_text: string;
  Validator_CMProductList_invalid_legacy_query_text: string;
...
const LiveContextStudioPluginValidator_properties: LiveContextStudioPluginValidator_properties = {
  ...
  Validator_CMProductList_invalid_legacy_name_text: "The filter \"{0}\" is not valid anymore. Please select a new value or enable multiple selections in the document form.",
  Validator_CMProductList_invalid_legacy_query_text: "The value \"{0}\" for filter \"{1}\" is not valid anymore. Please select a new value or enable multiple selections in the document form.",
