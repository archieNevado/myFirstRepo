...
ResourceBundleUtil.override(LiveContextStudioPluginValidator_properties, {
  ...
  Validator_CMProductList_invalid_legacy_name_text: "Der Filter \"{0}\" ist nicht mehr gültig. Bitte wählen Sie einen neuen Wert oder aktivieren Sie die Mehrfachauswahl im Dokumentenformular.",
  Validator_CMProductList_invalid_legacy_query_text: "Der Wert \"{0}\" für den Filter \"{1}\" ist nicht mehr gültig. Bitte wählen Sie einen neuen Wert oder aktivieren Sie die Mehrfachauswahl im Dokumentenformular.",
