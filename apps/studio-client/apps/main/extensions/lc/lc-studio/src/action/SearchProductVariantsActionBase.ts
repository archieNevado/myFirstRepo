...
class SearchProductVariantsActionBase extends LiveContextCatalogObjectAction {
  ...
  constructor(config: Config<SearchProductVariantsAction> = null) {
    ...
    const this$ = this;
    super(cast(SearchProductVariantsAction, ActionConfigUtil.extendConfiguration(resourceManager.getResourceBundle(null, LivecontextStudioPlugin_properties).content, config, "searchProductVariants", { handler: bind(this$, this$.#doExecute) })));
  }
