...
class AddCatalogObjectActionsToWorkAreaTabProxiesContextMenu extends AddItemsPlugin {
  ...
  #component: WorkAreaTabProxiesContextMenu = null;
  ...
  constructor(config: Config<AddCatalogObjectActionsToWorkAreaTabProxiesContextMenu> = null) {
    ...
    const this$ = this;
    this$.#component = cast(WorkAreaTabProxiesContextMenu, config.cmp);
      ...
      items: [
        ...
        Config(Item, {
          ...
          baseAction: new ShowTabEntityInRepositoryAction({
            contextClickedTabPanelValueExpression: this$.#component.getContextClickedTabPanelValueExpression(),
            contextClickedTabValueExpression: this$.#component.getContextClickedTabValueExpression(),
        ...
        Config(Separator),
        Config(Item, { baseAction: new CreateProductTeaserAction({ catalogObjectExpression: this$.#componentConfig.tabEntityExpression }) }),
        Config(Item, { baseAction: new AugmentCategoryAction({ catalogObjectExpression: this$.#componentConfig.tabEntityExpression }) }),
        Config(Item, { baseAction: new AugmentProductAction({ catalogObjectExpression: this$.#componentConfig.tabEntityExpression }) }),
      ],
    }), config));
  }
}
