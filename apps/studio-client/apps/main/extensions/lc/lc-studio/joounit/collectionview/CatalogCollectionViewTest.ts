...
class CatalogCollectionViewTest extends AbstractLiveContextStudioTest {
  ...
  override setUp(): void {
    ...
    this.#getPreferredSite = bind(editorContext._.getSitesService(), editorContext._.getSitesService().getPreferredSiteId);
  ...
  testCatalogLibrary(): void {
    this.chain(
      ...
      this.#selectNode("livecontext/category/HeliosSiteId/catalog/NO_WS/Women"),
      ...
      this.#selectNode("livecontext/category/HeliosSiteId/catalog/NO_WS/Dresses"),
      ...
      this.#selectNode("livecontext/marketing/HeliosSiteId/NO_WS"),
      this.#waitUntilSwitchToListButtonIsPressed(),
      this.#switchToThumbnailView(),
      this.#waitUntilSwitchToListButtonIsUnpressed(),
      this.#waitUntilThumbnailViewIsActive(),
  ...
  #switchToListView(): Step {
    return new ActionStep("Switch to list view",
      (): void => {
        this.#getSwitchToListViewButton().initialConfig.handler();
      });
  }
  ...
  #switchToThumbnailView(): Step {
    return new ActionStep("Switch to thumbnail view",
      (): void => {
        this.#getSwitchToThumbnailViewButton().initialConfig.handler();
      });
  }
  ...
  #switchToRepositoryMode(): Step {
    return new ActionStep("Switch to repository mode",
      (): void => {
        this.#getSwitchToRepositoryModeButton().initialConfig.handler();
      });
  }
  ...
  #searchProductVariantsUsingContextMenu(): Step {
    return new Step("Search Product Variants using the context menu",
      ...
      ,
      (): void => {
        this.#searchProductVariantsContextMenuItem.initialConfig.handler();
      },
    );
