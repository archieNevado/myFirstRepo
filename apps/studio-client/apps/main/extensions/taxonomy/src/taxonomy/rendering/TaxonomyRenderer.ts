...
class TaxonomyRenderer {
  ...
  static #nodeClicked(event: Event): void {
    const compId = as(event.target.getAttribute("data-componentId"), String);
    const nodeRef = as(event.target.getAttribute("data-ref"), String);
  ...
  static #plusMinusClicked(event: Event): void {
    const compId = as(event.target.getAttribute("data-componentId"), String);
    let nodeRef = as(event.target.getAttribute("data-ref"), String);
