        ...
        Config(ExtensionsMenuToolbar, {
          plugins: [
            Config(AddItemsPlugin, {
              items: [
                Config(Button, {
                  id: TaxonomyStudioPlugin.TAXONOMY_EDITOR_BUTTON_ID,
                  itemId: TaxonomyStudioPlugin.TAXONOMY_EDITOR_BUTTON_ID,
                  text: TaxonomyStudioPlugin_properties.TaxonomyEditor_title,
                  ui: ButtonSkin.HIGHLIGHT.getSkin(),
                  scale: "medium",
                  iconCls: CoreIcons_properties.tag,
                  baseAction: new OpenTaxonomyEditorAction({}),
                }),
              ],
            }),
          ],
