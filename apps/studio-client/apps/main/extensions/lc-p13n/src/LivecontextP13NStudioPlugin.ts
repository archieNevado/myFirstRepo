          ...
          plugins: [
            Config(AddItemsPlugin, {
              ...
              items: [
                ...
                Config(CommerceObjectsDisplayField, {
                  fieldLabel: LivecontextStudioPlugin_properties.p13n_commerce_user_contracts_label,
                  invalidMessage: LivecontextStudioPlugin_properties.p13n_commerce_user_contract_invalid,
                  emptyMessage: LivecontextStudioPlugin_properties.p13n_persona_commerce_contracts_empty,
