...
import AddSiteSpecificPathPlugin from "@coremedia-blueprint/studio-client.main.p13n-studio/plugin/AddSiteSpecificPathPlugin";
...
class LivecontextP13NStudioPluginBase extends StudioPlugin {
  ...
  static readonly USER_CONTRACTS: string = "usercontracts";
  ...
  static getContracts(store: Store): Array<any> {
