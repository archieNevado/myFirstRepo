...
class MarketingSpotTest extends AbstractCatalogTest {
  ...
  override setUp(): void {
    super.setUp();
    this.#marketingSpot = as(beanFactory._.getRemoteBean("livecontext/marketingspot/HeliosSiteId/NO_WS/spot1"), MarketingSpot);
  }

  testMarketingSpots(): void {
    (this.#marketingSpot as RemoteBean).load(this.addAsync((): void =>
