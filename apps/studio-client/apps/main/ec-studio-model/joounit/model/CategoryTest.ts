...
class CategoryTest extends AbstractCatalogTest {
  ...
  override setUp(): void {
    super.setUp();
    this.#rootCategory = as(beanFactory._.getRemoteBean("livecontext/category/HeliosSiteId/catalog/NO_WS/ROOT"), Category);
    this.#topCategory = as(beanFactory._.getRemoteBean("livecontext/category/HeliosSiteId/catalog/NO_WS/Grocery"), Category);
    this.#leafCategory = as(beanFactory._.getRemoteBean("livecontext/category/HeliosSiteId/catalog/NO_WS/Fruit"), Category);
  }

  testTopCategory(): void {
    (this.#topCategory as RemoteBean).load(this.addAsync((): void => {
  ...
  testLeafCategory(): void {
    (this.#leafCategory as RemoteBean).load(this.addAsync((): void => {
