...
class ProductTest extends AbstractCatalogTest {
  ...
  override setUp(): void {
    super.setUp();
    this.#product = as(beanFactory._.getRemoteBean("livecontext/product/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID), Product);
    this.#leafCategory = as(beanFactory._.getRemoteBean("livecontext/category/HeliosSiteId/catalog/NO_WS/Fruit"), Category);
  }

  testProduct(): void {
    (this.#product as RemoteBean).load(this.addAsync((): void => {
