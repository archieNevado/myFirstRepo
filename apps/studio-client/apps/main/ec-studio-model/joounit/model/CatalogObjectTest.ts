...
class CatalogObjectTest extends AbstractCatalogTest {
  ...
  override setUp(): void {
    super.setUp();
    this.#catalogObject = as(beanFactory._.getRemoteBean("livecontext/store/HeliosSiteId/NO_WS"), CatalogObject);
  }

  testCatalogObject(): void {
    (this.#catalogObject as RemoteBean).load(this.addAsync((): void =>
