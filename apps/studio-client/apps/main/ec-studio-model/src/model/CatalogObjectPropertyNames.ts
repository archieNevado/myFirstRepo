...
class CatalogObjectPropertyNames {
   ...
   */
  static readonly CONTRACTS: string = "contracts";
  ...
  static readonly VENDOR_URL: string = "vendorUrl";

  static readonly VENDOR_NAME: string = "vendorName";

  static readonly VENDOR_VERSION: string = "vendorVersion";
