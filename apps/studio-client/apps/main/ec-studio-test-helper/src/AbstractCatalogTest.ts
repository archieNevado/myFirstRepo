...
class AbstractCatalogTest extends AbstractRemoteTest {
  ...
  static readonly MOCK_RESPONSES: Array<any> = [
    ...
    {
      "request": {
        "uri": "livecontext/store/HeliosSiteId/NO_WS",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          },
          {
            ...
            "child": { "$Ref": "livecontext/marketing/HeliosSiteId/NO_WS" },
          }]
    ...
    {
      "request": {
        "uri": "livecontext/store/TestSiteId/NO_WS",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/marketing/HeliosSiteId/NO_WS",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          {
            "displayName": "Spot2",
            "child": { "$Ref": "livecontext/marketingspot/HeliosSiteId/NO_WS/spot2" },
          },
          {
            "displayName": "Spot3",
            "child": { "$Ref": "livecontext/marketingspot/HeliosSiteId/NO_WS/spot3" },
          }],
        },
      },
    },
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/ROOT",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          {
            "displayName": "Apparel",
            "child": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Apparel" },
          }],
          "subCategories": [
            { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Apparel" },
            { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Grocery" },
    ...
    {
      "request": {
        "uri": "livecontext/contracts/HeliosSiteId/NO_WS",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/contract/HeliosSiteId/NO_WS/4000000000000000507",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/contract/HeliosSiteId/NO_WS/4000000000000000508",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/contract/HeliosSiteId/NO_WS/invalidid",
        "method": "GET",
      },
      "response": { "code": 404 },
    },
    ...
    {
      "request": {
        "uri": "livecontext/store/Media/NO_WS",
        "method": "GET",
      },
      "response": { "code": 404 },
    },
    ...
    {
      "request": {
        "uri": "livecontext/marketingspot/HeliosSiteId/NO_WS/spot1",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "description": "spot1",
          "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
          "marketing": { "$Ref": "livecontext/marketing/HeliosSiteId/NO_WS" },
        },
      },
    },
    ...
    {
      "request": {
        "uri": "livecontext/marketingspot/HeliosSiteId/NO_WS/spot2",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/marketingspot/HeliosSiteId/NO_WS/spot3",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Grocery",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "childrenData": [{
            ...
            "child": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Vegetables" },
          }, {
            "displayName": "Fruit",
            "child": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Fruit" },
          }],
          "externalId": "Grocery",
          "displayName": "Grocery",
          "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
    ...
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Vegetables",
        "method": "GET",
      },
      "response": {
        "body": {
        ...
        "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
        "subCategories": [],
        "parent": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Grocery" },
      },
    },
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Apparel",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "childrenData": [
            {
              "displayName": "Women",
              "child": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Women" },
            },
          ],
          "externalId": "Apparel",
          "displayName": "Apparel",
    ...
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Women",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "childrenData": [
            {
              "displayName": "Dresses",
              "child": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Dresses" },
            },
          ],
          "externalId": "Women",
          "displayName": "Women",
          ...
          "parent": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Apparel" },
        },
      },
    },
    ...
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Dresses",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "childrenData": [
            {
              ...
              "child": { "$Ref": "livecontext/product/HeliosSiteId/catalog/NO_WS/AuroraWMDRS-1" },
            },
          ],
          "externalId": "Dresses",
          "displayName": "Dresses",
          ...
          "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
          "subCategories": [],
          "parent": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Women" },
        },
      },
    },
    ...
    {
      "request": {
        "uri": "livecontext/product/HeliosSiteId/catalog/NO_WS/AuroraWMDRS-1",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
          "category": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Dresses" },
    ...
    {
      "request": {
        "uri": "livecontext/sku/HeliosSiteId/catalog/NO_WS/AuroraWMDRS-001",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/sku/HeliosSiteId/catalog/NO_WS/AuroraWMDRS-002",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Home%20Furnishings",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Fruit",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "children": [
            { "$Ref": "livecontext/product/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID },
          ...
          "childrenData": [
            {
              "displayName": "Oranges",
              "child": { "$Ref": "livecontext/product/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID },
            },
            {
              "displayName": "Blackberries",
              "child": { "$Ref": "livecontext/product/HeliosSiteId/catalog/NO_WS/GFR033_3302" },
            },
            {
              "displayName": "Mangoes",
              "child": { "$Ref": "livecontext/product/HeliosSiteId/catalog/NO_WS/GFR033_3303" },
            },
          ],
    ...
    {
      "request": {
        "uri": "livecontext/category/HeliosSiteId/catalog/NO_WS/Link",
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "displayName": "Link",
          "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
          "subCategories": [{ "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Fruit" }],
          "parent": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Grocery" },
    ...
    {
      "request": {
        "uri": "livecontext/product/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID,
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
          "category": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Fruit" },
    ...
    {
      "request": {
        "uri": "livecontext/sku/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_SKU_EXTERNAL_ID,
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/sku/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID + "02",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/sku/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID + "03",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/product/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.BABY_SHOES_EXTERNAL_ID,
        "method": "GET",
      },
      "response": {
        "body": {
          ...
          "category": { "$Ref": "livecontext/category/HeliosSiteId/catalog/NO_WS/Boys%20Shoes" },
          "store": { "$Ref": "livecontext/store/HeliosSiteId/NO_WS" },
    ...
    {
      "request": {
        "uri": "livecontext/product/HeliosSiteId/catalog/NO_WS/xmp1",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/product/HeliosSiteId/catalog/NO_WS/xmp2",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/product/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID + 404,
        "method": "GET",
      },
      "response": { "code": 404 },
    },
    ...
    {
      "request": {
        "uri": "livecontext/product/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID + 503,
        "method": "GET",
      },
      "response": { "code": 503 },
    },
    ...
    {
      "request": {
        "uri": "livecontext/search/HeliosSiteId?query=*&searchType=Product&siteId=HeliosSiteId&workspaceId=NO_WS&limit=-1&includeSubfolders=true&includeSubtypes=true",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/search/HeliosSiteId?query=Oranges&searchType=Product&siteId=HeliosSiteId&workspaceId=NO_WS&filterQuery=&limit=-1",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/search/HeliosSiteId?category=10006&catalogAlias=catalog&query=AuroraWMDRS-1&searchType=ProductVariant&siteId=HeliosSiteId&workspaceId=NO_WS&filterQuery=&limit=-1",
        "method": "GET",
      },
      "response": {
        "body": {
    ...
    {
      "request": {
        "uri": "livecontext/search/HeliosSiteId?query=Oranges&searchType=ProductVariant&siteId=HeliosSiteId&workspaceId=NO_WS&filterQuery=&limit=-1",
        "method": "GET",
      },
      "response": {
        "body": {
          "hits": [
            { "$Ref": "livecontext/sku/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_SKU_EXTERNAL_ID },
            { "$Ref": "livecontext/sku/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID + "02" },
            { "$Ref": "livecontext/sku/HeliosSiteId/catalog/NO_WS/" + AbstractCatalogTest.ORANGES_EXTERNAL_ID + "03" },
          ],
          "total": 3,
        },
      },
