...
class CatalogRepositoryListBase extends AbstractCatalogList {
  ...
  #selectionChanged(): void {
    ...
    if (is(value, Marketing)) {
      (this.getView() as unknown)["emptyText"] = ECommerceStudioPlugin_properties.CatalogView_spots_selection_empty_text;
    } else {
      (this.getView() as unknown)["emptyText"] = ECommerceStudioPlugin_properties.CatalogView_empty_text;
    }
  ...
  #sortChanged(headerContainer: HeaderContainer, column: Column, direction: string, eOpts: any): void {
