...
class AbstractCatalogStudioTest extends AbstractCatalogTest {
  ...
  protected static readonly STORE_CONTEXT_ID: string = AbstractCatalogStudioTest.HELIOS_SITE_ID + "/NO_WS";

  protected static readonly STORE_CATALOG_CONTEXT_ID: string = AbstractCatalogStudioTest.HELIOS_SITE_ID + "/catalog/NO_WS";
