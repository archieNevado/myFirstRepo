...
class CatalogTreeModelTest extends AbstractCatalogStudioTest {
  ...
  testGetStoreText(): void {
    this.waitUntil("wait for store text",
      (): boolean =>
        this.#catalogTreeModel.getText(AbstractCatalogStudioTest.STORE_ID)
      ,
      (): void =>
  ...
  testGetTopCategoryText(): void {
    this.waitUntil("wait for the top category loaded",
      (): boolean =>
        this.#catalogTreeModel.getText(AbstractCatalogStudioTest.TOP_CATEGORY_ID)
      ,
      (): void =>
  ...
  testGetLeafCategoryText(): void {
    this.waitUntil("wait for the leaf category loaded",
      (): boolean =>
        this.#catalogTreeModel.getText(AbstractCatalogStudioTest.LEAF_CATEGORY_ID)
      ,
      (): void =>
  ...
  testGetLeafCategoryIdPath(): void {
    this.waitUntil("wait for leaf category id path",
      (): boolean =>
        this.#catalogTreeModel.getIdPath(AbstractCatalogStudioTest.LEAF_CATEGORY_ID)
      ,
      (): void => {
  ...
  testGetTopCategoryChildren(): void {
    this.waitUntil("wait for top category children",
      (): boolean =>
        this.#catalogTreeModel.getChildren(AbstractCatalogStudioTest.TOP_CATEGORY_ID)
      ,
      (): void => {
  ...
  testIdsAreConcatinatedWithLinkPrefix(): void {
    this.waitUntil("wait for top category children",
      (): boolean =>
        this.#catalogTreeModel.getChildren(AbstractCatalogStudioTest.LINK_CATEGORY_ID)
      ,
      (): void => {
  ...
  testGetLeafCategoryChildren(): void {
    this.waitUntil("wait for leaf category children",
      (): boolean =>
        this.#catalogTreeModel.getChildren(AbstractCatalogStudioTest.LEAF_CATEGORY_ID)
      ,
      (): void => {
  ...
  testGetStoreChildren(): void {
    this.waitUntil("wait for store children",
      (): boolean =>
        this.#catalogTreeModel.getChildren(AbstractCatalogStudioTest.STORE_ID)
      ,
      (): void => {
  ...
  testGetMarketingSpotsText(): void {
    this.waitUntil("wait for tree to be build",
      (): boolean =>
        this.#catalogTreeModel.getText(AbstractCatalogStudioTest.MARKETING_ID)
      ,
      (): void =>
  ...
  testGetRootId(): void {
    this.waitUntil("wait for root id to be loaded",
      (): boolean =>
        this.#catalogTreeModel.getRootId() === AbstractCatalogStudioTest.STORE_ID
      ,
      (): void =>
  ...
  testGetStoreIdPath(): void {
    this.waitUntil("wait for store id path",
      (): boolean =>
        this.#catalogTreeModel.getIdPath(AbstractCatalogStudioTest.STORE_ID)
      ,
      (): void => {
