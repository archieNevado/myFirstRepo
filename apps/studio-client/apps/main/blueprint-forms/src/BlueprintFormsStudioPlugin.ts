...
import FavoritesToolbar from "@coremedia/studio-client.main.editor-components/sdk/desktop/FavoritesToolbar";
import FavoritesToolbarUserItemsArea from "@coremedia/studio-client.main.editor-components/sdk/desktop/FavoritesToolbarUserItemsArea";
  ...
  constructor(config: Config<BlueprintFormsStudioPlugin> = null) {
    ...
    super(ConfigUtils.apply(Config(BlueprintFormsStudioPlugin, {
      ...
      rules: [
        ...
        Config(FavoritesToolbarUserItemsArea, {
          plugins: [
            Config(AddArrayItemsPlugin, {
              arrayProperty: FavoritesToolbarUserItemsArea.DEFAULT_ITEMS,
              items: [ {
                "_main": {
                  "searchText": "",
        ...
        Config(FavoritesToolbar, {
          plugins: [
            Config(AddItemsPlugin, {
              after: [
                Config(Button, { itemId: FavoritesToolbar.NEW_MENU_BUTTON_ITEM_ID }),
              ],
            }),
          ],
        }),
      ...
      configuration: [
        ...
        new ConfigureDocumentTypes({
          ...
          previewUrlTransformers: [
            new AddDependingParameterPreviewUrlTransformer({
              name: "contentType",
              valueExpression: this$.getContentTypeVE(),
            }),
          ],
        }),
        ...
        new ConfigureDocumentTypes({
          names: "CMObject",
          mayPreview: bind(this$, this$.isValidCMLinkable),
        }),
