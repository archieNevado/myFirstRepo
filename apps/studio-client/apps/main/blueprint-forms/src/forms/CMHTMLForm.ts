...
import RichTextPropertyField from "@coremedia/studio-client.main.editor-components/sdk/premular/fields/RichTextPropertyField";
import StringPropertyField from "@coremedia/studio-client.main.editor-components/sdk/premular/fields/StringPropertyField";
import HideRichTextToolbarPlugin from "@coremedia/studio-client.main.editor-components/sdk/premular/fields/plugins/HideRichTextToolbarPlugin";
            ...
            Config(PropertyFieldGroup, {
              ...
              items: [
                Config(RichTextPropertyField, {
                  ...
                  ...ConfigUtils.append({
                    plugins: [
                      cast(HideRichTextToolbarPlugin, {}),
                    ],
                  }),
                }),
              ],
