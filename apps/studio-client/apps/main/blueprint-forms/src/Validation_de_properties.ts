...
ResourceBundleUtil.override(Validation_properties, {
  ...
  Validator_not_in_site_text: "Dieses Dokument hat keinen Navigationskontext.",
  ...
  Validator_placement_visibility_not_witihn_validity_text: "Der Sichtbarkeitsbereich für das Dokument '{0}' ist nicht innerhalb seines Gültigkeitsbereichs.",
});
