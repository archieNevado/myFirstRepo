...
@EditorDefault
@Scope("prototype")
public class CatalogSearchContextMenu extends CollectionRepositoryContextMenu {
  public static final String XTYPE = "com.coremedia.ecommerce.studio.config.catalogSearchContextMenu";
