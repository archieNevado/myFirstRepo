...
@ExtJSObject(id = "spinnerWindow")
@Scope("prototype")
public class CreateSpinnerWindow extends Window {
    public static final String XTYPE = "com.coremedia.blueprint.base.components.config.createSpinnerWindow";
    ...
    private TextField spinnerNameField;
    ...
    public TextField getSpinnerNameField() {
        return spinnerNameField;
    }
