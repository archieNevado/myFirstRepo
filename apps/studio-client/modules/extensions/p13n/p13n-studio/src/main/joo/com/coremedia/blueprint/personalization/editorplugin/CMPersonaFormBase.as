...
public class CMPersonaFormBase extends DocumentTabPanel {
  ...
  public function CMPersonaFormBase(config:CMPersonaForm = null) {
    ...
    remoteValue.loadValue(function (structRemoteBean:StructRemoteBean):void {
   ...
   */
  private static function createPropertiesIfNecessary(structRemoteBean:StructRemoteBean):void {
