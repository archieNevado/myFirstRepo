...
public abstract class IbmServiceTestBase extends AbstractServiceTest {
  ...
  @PropertySource(
          value = {
                  ...
                  "classpath:/com.coremedia.livecontext.ecommerce.ibm.cae.testbase/test-commerce-services.properties",
                  "classpath:/com.coremedia.livecontext.ecommerce.ibm.cae.testbase/ibm-example-catalog.properties"
          }
  )
  @ImportResource(
          value = {
                  "classpath:/com.coremedia.livecontext.ecommerce.ibm.cae.testbase/test-commerce-services.xml",
