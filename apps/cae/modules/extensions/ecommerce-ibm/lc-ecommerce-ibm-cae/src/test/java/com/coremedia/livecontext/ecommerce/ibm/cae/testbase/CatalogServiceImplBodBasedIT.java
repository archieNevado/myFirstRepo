...
import static com.coremedia.livecontext.ecommerce.ibm.cae.testbase.IbmCatalogServiceBaseTest.IBM_TEST_URL;
...
public class CatalogServiceImplBodBasedIT extends IbmCatalogServiceBaseTest {
  ...
  @ImportResource(
          value = {
                  "classpath:/com.coremedia.livecontext.ecommerce.ibm.cae.testbase/test-commerce-services-bod-customizers.xml"
          },
