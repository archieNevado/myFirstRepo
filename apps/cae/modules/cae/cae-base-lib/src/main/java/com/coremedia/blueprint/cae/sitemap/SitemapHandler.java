...
public class SitemapHandler {
  ...
  private static final String ACTION_NAME = "sitemap";
  ...
  /**
   * For backward compatibility only.  This pattern violates the "Sitemap file location"
   * constraint of https://www.sitemaps.org/protocol.html .  Sitemaps with such URLs
   * should gradually vanish.
   *
   * @deprecated use {@link #URI_PATTERN_SITEMAP}
   */
  @Deprecated
  ...
  /**
   * Such URLs are no longer generated by the Blueprint.
   * They may exist in outdated sitemaps, though.
   *
   * @deprecated replaced by {@link #handleRequest(String, String)}
   */
  @Deprecated
  @GetMapping({URI_PATTERN})
  public ModelAndView handleRequest(@PathVariable(SITEMAP_PATH) String sitemapPath) {
    return handleRequestInternal(sitemapPath);
  }
