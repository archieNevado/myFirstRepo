...
public class SitemapHelperTest {
  ...
  private static final String SITEMAP_CONFIG_KEY = "sitemapConfigKey";
  ...
  public void setup() {
    ...
    when(settingsService.setting(SitemapHelper.SITEMAP_ORG_CONFIGURATION_KEY, String.class, site)).thenReturn(SITEMAP_CONFIG_KEY);
    when(sitemapSetup.getProtocol()).thenReturn("https");
    testling = new SitemapHelper(Map.of(SITEMAP_CONFIG_KEY, sitemapSetup), settingsService, urlPrefixResolver, false);
  }
